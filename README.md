...
[![Build Status](https://travis-ci.org/powerling-rd/akeneo-extension.svg)](https://travis-ci.org/powerling-rd/akeneo-extension)
...
```
composer require powerling/akeneo-extension
```
