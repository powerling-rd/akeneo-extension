...
[![Build Status](https://travis-ci.org/powerling-rd/akeneo-extension.svg?branch=2.3)](https://travis-ci.org/powerling-rd/akeneo-extension)
...
```
powerling.base_uri: 'https://api.powerling-tp.com'
```
