...
define(
    [
        ...
        'pim/initselect2',
        'powerling/template/system/group/configuration'
    ],
    function (_,
              __,
              Routing,
        ...
        return BaseForm.extend({
            ...
            isGroup: true,
            label: __('powerling.configuration.tab.label'),
            ...
            render() {
                this.$el.html(this.template({
                    apikey: this.getFormData()['pim_powerling___api_key'] ?
                        this.getFormData()['pim_powerling___api_key'].value : '',
                    attributes: this.getFormData()['pim_powerling___attributes'] ?
                        this.getFormData()['pim_powerling___attributes'].value : ''
                }));
